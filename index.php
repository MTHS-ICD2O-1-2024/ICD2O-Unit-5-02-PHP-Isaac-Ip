...
<body>
  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <main class="mdl-layout__content">
      ...
      <br />
      <div class="page-content">Select what kind of number you would like:
      </div>
      <div class="page-content-php">
        <form action="answer.php" method="GET">
          <br />
          <input type="radio" name="symbol" value="positive">Positive
          <input type="radio" name="symbol" value="negative">Negative
        </label>  
          </div>
          <br />
